...
public class ExampleMod
{
    ...
    public static final String MODID = "medieval_fantasy";
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        if (event.getTabKey() == CreativeModeTabs.COMBAT) {
            event.accept(ModItems.ETERNAL_FIRE_BLADE.get());
            event.accept(ModItems.CAVALEIRO_DAS_CINZAS_SPAWN_EGG.get());
        }
    }

    private void registerEntityAttributes(EntityAttributeCreationEvent event)
    {
        event.put(ModEntities.CAVALEIRO_DAS_CINZAS.get(), CavaleiroDasCinzas.createAttributes().build());
    }
    ...
    public static class ClientModEvents
    {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            EntityRenderers.register(ModEntities.CAVALEIRO_DAS_CINZAS.get(), CavaleiroDasCinzasRenderer::new);
        }
    }
}
